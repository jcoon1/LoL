...
exp.PresentItems = [{Blue : [{Name: "Aatrox", Image: "../_shared/images/champions/Aatrox.jpg"},
{Name: "Ahri", Image: "../_shared/images/champions/Ahri.jpg"},
{Name: "Akali", Image: "../_shared/images/champions/Akali.jpg"},
{Name: "Alistair", Image: "../_shared/images/champions/Alistair.jpg"},
{Name: "Amumu", Image: "../_shared/images/champions/Amumu.jpg"},
...
{Name: "Ashe", Image: "../_shared/images/champions/Ashe.jpg"},
{Name: "Aurelion Sol", Image: "../_shared/images/champions/Aurelion_Sol.jpg"}],
Red : [{Name: "Aatrox", Image: "../_shared/images/champions/Aatrox.jpg"},
{Name: "Ahri", Image: "../_shared/images/champions/Ahri.jpg"},
{Name: "Akali", Image: "../_shared/images/champions/Akali.jpg"},
{Name: "Alistair", Image: "../_shared/images/champions/Alistair.jpg"},
{Name: "Amumu", Image: "../_shared/images/champions/Amumu.jpg"},
...
{Name: "Ashe", Image: "../_shared/images/champions/Ashe.jpg"},
{Name: "Aurelion Sol", Image: "../_shared/images/champions/Aurelion_Sol.jpg"}]},
{Blue : [{Name: "Aatrox", Image: "../_shared/images/champions/Aatrox.jpg"},
{Name: "Ahri", Image: "../_shared/images/champions/Ahri.jpg"},
{Name: "Akali", Image: "../_shared/images/champions/Akali.jpg"},
{Name: "Alistair", Image: "../_shared/images/champions/Alistair.jpg"},
{Name: "Amumu", Image: "../_shared/images/champions/Amumu.jpg"},
...
function make_slides(f) {
  ...
  slides.main_questions = slide({
	...
	this.sentence_types = ["Early", "Carry", "Kiting", "Objectives", "SplitPush"];
      var sentences = {
        "Early": "...initiating fights in the early game?",
        "Carry": "...protecting their carry (or carries)?",
        "Kiting": "...keeping the opposition at a distance?",
        "Objectives": "...objectives rather than teamfights?",
        "SplitPush": "...split-pushing in the late game?"
      };
      ...
      for (var i=0; i<this.n_sliders; i++) {
        ...
        $("#multi_slider_table_Blue").append('<tr class="slider_row"><td class="slider_target" id="sentence' + i + '">' + sentence + '</td><td colspan="2"><div id="slider' + i + '" class="slider">-------[ ]--------</div></td></tr>');
        utils.match_row_height("#multi_slider_table", ".slider_target");
        $("#multi_slider_table_Red").append('<tr class="slider_row"><td class="slider_target" id="sentence' + i + '">' + sentence + '</td><td colspan="2"><div id="slider' + i + '" class="slider">-------[ ]--------</div></td></tr>');
        utils.match_row_height("#multi_slider_table", ".slider_target");
      }
      ...
      //   var sentence_type = this.sentence_types[i];
      //   var sentence = sentences[sentence_type];
      //   $("#multi_slider_table_1").append('<tr class="slider_row"><td class="slider_target" id="sentence' + i + '">' + sentence + '</td><td colspan="2"><div id="slider' + i + '" class="slider">-------[ ]--------</div></td></tr>');
      //   utils.match_row_height("#multi_slider_table", ".slider_target");
      // }
